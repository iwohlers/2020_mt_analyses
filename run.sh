...
snakemake -j 8 --rerun-incomplete -k -p --use-conda combined_mt_fasta_german combined_mt_vcf_german combined_german_haplogroup_file combined_german_contamination_file
