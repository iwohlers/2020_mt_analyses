...
snakemake -j 8 --rerun-incomplete -k -p --use-conda figures/GERMAN2021/haplogroup_distributions_1.pdf #GERMAN2021/mapped/summary.stats #combined_mt_fasta_germancentenarian #combined_mt_fasta_german combined_mt_vcf_german combined_german_haplogroup_file combined_german_contamination_file control_mt/hgdp_mt.vcf.gz control_mt/hgdp_mt.fa
